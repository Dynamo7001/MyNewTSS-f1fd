[MyNewTSS-f1fd] Operating Details
====================================

Generated On: 2024-10-17 20:27:34 UTC
...
.. important::
   ...
   **not be valid if your [MyNewTSS-f1fd] container is NOT running**.

.. tip::
   You must have your [MyNewTSS-f1fd] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39839  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Dynamo7001'  \-\-env DOCKERUSERNAME='hooluwole'  \-\-env MQTTUSERNAME='hammed'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   hooluwole/MyNewTSS-f1fd-amd64 (https://hub.docker.com/r/hooluwole/MyNewTSS-f1fd-amd64)
...
.. important::
   docker run -d -p 45807:45807 -p 49849:49849 -p 34613:34613 \-\-env TSS=0 \-\-env SOLUTIONNAME=MyNewTSS-f1fd \-\-env SOLUTIONDAG=solution_preprocessing_dag-MyNewTSS-f1fd \-\-env GITUSERNAME=Dynamo7001  \-\-env GITREPOURL=https://github.com/Dynamo7001/raspberrypi \-\-env SOLUTIONEXTERNALPORT=45807  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=49849  \-\-env SOLUTIONVIPERVIZPORT=34613 \-\-env DOCKERUSERNAME='hooluwole'  \-\-env EXTERNALPORT=39839 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='hammed' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole/MyNewTSS-f1fd-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=34613
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=45807
...
It can be accessed by entering: http://localhost:49849
...
.. important::
   http://localhost:34613/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:34613/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:34613/<html file>
...
[MyNewTSS-f1fd] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Dynamo7001/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/MyNewTSS-f1fd
...
.. important::
   https://MyNewTSS-f1fd.readthedocs.io
...
.. important::
   solution_preprocessing_dag-MyNewTSS-f1fd
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=45807, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42945, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42069, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36547, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38177, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43991, HPDEHOST=127.0.1.1, HPDEPORT=36179, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44083

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-908-MyNewTSS-f1fd,solution_preprocessing_dag-MyNewTSS-f1fd, python-preprocess-7882-MyNewTSS-f1fd,solution_preprocessing_dag-MyNewTSS-f1fd, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
